...
from features.feature_pipeline import FEATURE_COLUMNS, build_feature_frame, run_feature_build_pipeline
...
def test_dataset_builder_creates_temporal_split(tmp_path: Path) -> None:
    ...
    dataset = build_training_dataset(feature_frame, settings)
